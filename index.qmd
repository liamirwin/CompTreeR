...
We will start by loading relevant packages and an example dataset; clipped from the Irwin et al. 2024 data

-   To speed up computation in this example the data has been thinned from the original density (\~1200 pts/m2) using a 25cm voxel retaining 1 point, resulting in a density of (173 points/m2).
...
chm <- rasterize_canopy(las, res = 0.1, p2r(subcircle = 0.075))
...
![](images/alphashape_visualization.png)
